...
[compatibility matrix](../../../docs/compatibility.md) for the supported robot software
...
[compatibility matrix](../../../docs/compatibility.md) lists which software has the EDU
router.
