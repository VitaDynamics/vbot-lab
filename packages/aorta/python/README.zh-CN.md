...
接收实时状态。支持的机器人镜像见[兼容矩阵](../../../release/compatibility.zh-CN.md)，
...
另见[兼容矩阵](../../../release/compatibility.zh-CN.md)。
...
EDU 路由器见[兼容矩阵](../../../release/compatibility.zh-CN.md)。
...
以及所选机器人镜像是否提供该话题（见[兼容矩阵](../../../release/compatibility.zh-CN.md)）。
