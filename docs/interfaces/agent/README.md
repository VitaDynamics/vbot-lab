...
API availability depends on the device's firmware and runtime version.
Check the [compatibility matrix](../../../release/compatibility.md) before integration;
minimum supported versions have not yet been published.
