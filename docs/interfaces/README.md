...
The interface reference targets robot application **V1.6.0** on `foot_quadruped` EDU;
see [compatibility](../compatibility.md) for component pairing and configuration limits.
