...
The current scope is `foot_quadruped` EDU firmware exposing the routes below; a minimum
firmware version is not yet published. Log in with the vbot account and complete
