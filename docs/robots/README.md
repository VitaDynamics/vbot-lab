...
- Hardware: keep specifications in [docs/hardware/](../hardware/README.md).
  The two robot-dog types link to the same [sensor specification](../hardware/quadruped-common/sensors.md)
  and [back mounting / arm adapter reference](../hardware/quadruped-common/back-mounting.md).
